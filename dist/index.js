...
jquery__WEBPACK_IMPORTED_MODULE_1__(($) => {
    _jreact__WEBPACK_IMPORTED_MODULE_0__["render"](_jreact__WEBPACK_IMPORTED_MODULE_0__["createElement"]('span', { key: "test", className: 'titi' }, 'hello'), $('#container'));
});
...
/*!***********************!*\
  !*** ./src/jreact.ts ***!
  \***********************/
/*! exports provided: DEBUG, TEST, INSTANCE, DATA_KEY, RSL_VALID_REQUIRED, RSL_INVALID_REQUIRED, RSL_VALID_PATTERN, RSL_INVALID_PATTERN, DATA_FIXED_ITEM, DATA_REQUIRED, DATA_PATTERN, VALUE, Action, getInstance, getInstanceKey, getInstanceKeyFromTag, isSame, NOOP, createElement, render, renderDOM, Component, ComponentDOM, AutoTemplate, StatelessAutoTemplate, getDynamicComponent, getPropByKey, DynamicStatelessAutoTemplate, ComponentController, SingleComponentController, SingleComponentConverter, hasInvalidPattern, hasInvalidRequired, getTemplateContent, bootstrap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RSL_VALID_REQUIRED", function() { return RSL_VALID_REQUIRED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RSL_INVALID_REQUIRED", function() { return RSL_INVALID_REQUIRED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RSL_VALID_PATTERN", function() { return RSL_VALID_PATTERN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RSL_INVALID_PATTERN", function() { return RSL_INVALID_PATTERN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATA_FIXED_ITEM", function() { return DATA_FIXED_ITEM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATA_REQUIRED", function() { return DATA_REQUIRED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DATA_PATTERN", function() { return DATA_PATTERN; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInstanceKey", function() { return getInstanceKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInstanceKeyFromTag", function() { return getInstanceKeyFromTag; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComponentDOM", function() { return ComponentDOM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AutoTemplate", function() { return AutoTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatelessAutoTemplate", function() { return StatelessAutoTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDynamicComponent", function() { return getDynamicComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPropByKey", function() { return getPropByKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicStatelessAutoTemplate", function() { return DynamicStatelessAutoTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComponentController", function() { return ComponentController; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleComponentController", function() { return SingleComponentController; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleComponentConverter", function() { return SingleComponentConverter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasInvalidPattern", function() { return hasInvalidPattern; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hasInvalidRequired", function() { return hasInvalidRequired; });
...
const RSL_VALID_REQUIRED = 'rsl-valid-required';
const RSL_INVALID_REQUIRED = 'rsl-invalid-required';
const RSL_VALID_PATTERN = 'rsl-valid-pattern';
const RSL_INVALID_PATTERN = 'rsl-invalid-pattern';
const DATA_FIXED_ITEM = 'data-fixed-item';
...
function getInstanceKeyFromTag(tag, key) {
    ...
    if (_utils__WEBPACK_IMPORTED_MODULE_0__["testString"](key))
...
function createElement(jrc, props, ...args) {
    let childKeys = {};
    if (args.length > 1) {
        if (_utils__WEBPACK_IMPORTED_MODULE_0__["isStringOrNumber"](args[0]))
            throw new Error('multiple children with string or number');
        args.forEach(function (child) {
            if (_utils__WEBPACK_IMPORTED_MODULE_0__["isStringOrNumber"](child))
                return;
    ...
    Object.keys(comp.props).forEach(function (key) {
        ...
        if (ATTRIBUTE_MAP.hasOwnProperty(key)) {
            ...
            if (typeof value === 'function') {
                ...
                if (_utils__WEBPACK_IMPORTED_MODULE_0__["isBoolean"](value))
...
function render(comp, mount, sibling) {
    let childSibling, oldComp, prevProps, prevState, first = false, children = [], childKeyElements = {}, instanceKey = getInstanceKey(comp), oldHTML;
    ...
    if (alreadyMounted && (oldComp = getInstance(el))) {
        ...
        first = true;
        if (!alreadyMounted)
            el = jquery__WEBPACK_IMPORTED_MODULE_1__('<' + comp.getTag() + '/>');
        comp.setElement(el);
        setInstance(el, comp);
    ...
    if (comp instanceof AutoTemplate)
        ...
        if (renderResult) {
            if (_utils__WEBPACK_IMPORTED_MODULE_0__["isArray"](renderResult))
        ...
        el.children().each(function () {
            let jEl = jquery__WEBPACK_IMPORTED_MODULE_1__(this), inst = getInstance(jEl);
        ...
        children.forEach(function (child) {
            if (child instanceof Component) {
                ...
                if (child.props.ref != null) {
                    if (_utils__WEBPACK_IMPORTED_MODULE_0__["isFunction"](child.props.ref))
...
function renderDOM(comp, m) {
    ...
    m.children().each(function () {
        if (this !== el[0])
            unmountElement(jquery__WEBPACK_IMPORTED_MODULE_1__(this));
    });
    return el;
}
...
class Component {
    constructor(props) {
        ...
        if (defaultProps)
            props = jquery__WEBPACK_IMPORTED_MODULE_1__["extend"](true, {}, defaultProps, props);
        this.props = props;
    }
    getDefaultProps() {
        return null;
    ...
    setState(nextState) {
        if (this.shouldComponentUpdate(this.props, nextState)) {
            ...
            if (!TEST) {
                ...
                if (renderResult) {
                    if (_utils__WEBPACK_IMPORTED_MODULE_0__["isArray"](renderResult))
                        render(createElement(this.constructor, this.props, ...renderResult), this.element.parent());
                    else
...
class AutoTemplate extends Component {
    ...
    renderTemplate() {
        ...
        if (!_utils__WEBPACK_IMPORTED_MODULE_0__["isUndefined"](templateHTML) && !el.html())
    ...
    preRenderTemplate() {
        ...
        this.getElement().children('[' + DATA_KEY + ']').each(function () {
            ...
            if (!inst || !childKeyElements[getInstanceKey(inst)])
                unmountElement(jEl, !_utils__WEBPACK_IMPORTED_MODULE_0__["isUndefined"](templateHTML));
        });
    }
    _preRenderTemplate() {
    }
    postRenderTemplate() {
        ...
        if (components)
            components.forEach(component => {
                sibling = render(createElement(evalComponent(component), component), this.getElement(), _utils__WEBPACK_IMPORTED_MODULE_0__["isUndefined"](templateHTML) ? sibling : undefined);
...
class ComponentController {
    ...
    dispatch(action) {
        let actionHandler = this.getActionHandler(action.type), oldState = _utils__WEBPACK_IMPORTED_MODULE_0__["extend"](this.state);
        this.state = actionHandler.reduce(this, action);
        if (_utils__WEBPACK_IMPORTED_MODULE_0__["isFunction"](actionHandler.preRenderTemplate)) {
    ...
    render(actionHandler, action) {
        ...
        for (let converter of this.converters) {
            ...
            render(createElement(component.constructor, newProps), component.getElement().parent());
        }
        if (_utils__WEBPACK_IMPORTED_MODULE_0__["isFunction"](actionHandler.postRenderTemplate))
...
/*!**********************!*\
  !*** ./src/utils.ts ***!
  \**********************/
/*! exports provided: parseURL, flatten, sum, negateFunction, identity, matcher, escapeRegex, filter, trimSpecial, uuid, pluralize, capitalize, store, extend, nextUid, camelCase, snake_case, debounce, throttle, now, isUndefined, isDefined, isObject, isString, testString, isNumber, isStringOrNumber, isDate, isFunction, isRegExp, isFile, isBlob, isBoolean, isArray, isPromiseLike, curry, groupBy, createChainedFunction, addClass, removeClass, FORMAT_VALUES, addScript */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "negateFunction", function() { return negateFunction; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trimSpecial", function() { return trimSpecial; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "snake_case", function() { return snake_case; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FORMAT_VALUES", function() { return FORMAT_VALUES; });
...
const now = typeof window !== 'undefined' && window && window.performance ? window.performance.now.bind(window.performance) : Date.now;
/**
 * @ngdoc function
