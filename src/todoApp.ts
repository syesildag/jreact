...
export class TodoApp extends React.Component<Counter.CounterProps, Counter.CounterState> {
  constructor(props: Counter.CounterProps, context: any) {
    super(props, context);
  ...
  handleNewTodoKeyDown(event: KeyboardEvent) {
    if (event.keyCode !== Counter.ENTER_KEY) {
      return;
    }
